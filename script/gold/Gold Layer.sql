...
FROM 
silver.crm_cust_info AS ci LEFT JOIN silver.erp_cust_az12 AS ca
ON ci.cst_key = ca.cid LEFT JOIN silver.erp_loc_a101 AS la
...
FROM 
silver.crm_prd_info AS pn LEFT JOIN silver.erp_px_cat_g1v12 AS px
ON pn.cat_id = px.id
